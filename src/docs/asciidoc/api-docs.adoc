...
include::{snippets}/user/find-my-info/curl-request.adoc[]
...
include::{snippets}/profile/find-user/curl-request.adoc[]
...
include::{snippets}/profile/follow/curl-request.adoc[]
...
include::{snippets}/profile/unfollow/curl-request.adoc[]
...
include::{snippets}/article/find-one-by-slug/curl-request.adoc[]